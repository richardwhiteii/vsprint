...
var require_utils = __commonJS({
  "node_modules/mocha/lib/utils.js"(exports2) {
    ...
    exports2.clamp = function clamp(value, range2) {
      return Math.min(Math.max(value, range2[0]), range2[1]);
    };
...
// node_modules/mocha/node_modules/chalk/node_modules/supports-color/index.js
var require_supports_color2 = __commonJS({
  "node_modules/mocha/node_modules/chalk/node_modules/supports-color/index.js"(exports2, module2) {
    "use strict";
    var os = require("os");
    var tty = require("tty");
    var hasFlag = require_has_flag();
...
// node_modules/mocha/node_modules/chalk/source/util.js
var require_util = __commonJS({
  "node_modules/mocha/node_modules/chalk/source/util.js"(exports2, module2) {
    "use strict";
...
// node_modules/mocha/node_modules/chalk/source/templates.js
var require_templates = __commonJS({
  "node_modules/mocha/node_modules/chalk/source/templates.js"(exports2, module2) {
    "use strict";
...
// node_modules/mocha/node_modules/chalk/source/index.js
var require_source = __commonJS({
  "node_modules/mocha/node_modules/chalk/source/index.js"(exports2, module2) {
    "use strict";
...
var require_runnable = __commonJS({
  "node_modules/mocha/lib/runnable.js"(exports2, module2) {
    ...
    Runnable.prototype.timeout = function(ms) {
      ...
      var range2 = [0, MAX_TIMEOUT];
      ms = utils.clamp(ms, range2);
      if (ms === range2[0] || ms === range2[1]) {
        this._timeout = 0;
      } else {
        this._timeout = ms;
      }
  ...
  "node_modules/mocha/lib/reporters/json.js"(exports2, module2) {
    ...
    function JSONReporter(runner, options = {}) {
      ...
      runner.once(EVENT_RUN_END, function() {
        ...
        if (output) {
          try {
            fs.mkdirSync(path3.dirname(output), { recursive: true });
  ...
  "node_modules/mocha/lib/reporters/xunit.js"(exports2, module2) {
    ...
    function XUnit(runner, options) {
      ...
      if (options && options.reporterOptions) {
        if (options.reporterOptions.output) {
          ...
          fs.mkdirSync(path3.dirname(options.reporterOptions.output), {
            recursive: true
          });
        ...
        this.write(
          tag(
            ...
            tag(
              ...
              {},
              false,
              escape2(err.message) + escape2(diff) + "\n" + escape2(err.stack)
            )
          )
        );
    ...
    function testFilePath(filepath, options) {
      if (options && options.reporterOptions && options.reporterOptions.showRelativePaths) {
        return path3.relative(process.cwd(), filepath);
      }
      return filepath;
    }
  ...
  "node_modules/mocha/lib/reporters/landing.js"(exports2, module2) {
    ...
    function Landing(runner, options) {
      ...
      runner.on(EVENT_TEST_END, function(test) {
        ...
        stream2.write("\x1B[" + (width + 1) + "D\x1B[2A");
        stream2.write(runway());
        stream2.write("\n  ");
        stream2.write(color("runway", Array(col).join("\u22C5")));
        stream2.write(plane);
        stream2.write(color("runway", Array(width - col).join("\u22C5") + "\n"));
        stream2.write(runway());
        stream2.write("\x1B[0m");
      });
      runner.once(EVENT_RUN_END, function() {
        cursor.show();
        process.stdout.write("\n");
...
var require_parallel_buffered_runner = __commonJS({
  "node_modules/mocha/lib/nodejs/parallel-buffered-runner.js"(exports2, module2) {
    ...
    var states = createMap({
      ...
      [ABORTED2]: /* @__PURE__ */ new Set(),
      [ABORTING]: /* @__PURE__ */ new Set([ABORTED2]),
...
var require_mocha = __commonJS({
  "node_modules/mocha/lib/mocha.js"(exports2, module2) {
    ...
    if (!utils.isBrowser() && typeof module2.paths !== "undefined") {
      cwd = utils.cwd();
      module2.paths.push(cwd, path3.join(cwd, "node_modules"));
    }
    var cwd;
      ...
      if (typeof reporterName === "function") {
        ...
        if (!reporter) {
          ...
          try {
            ...
            try {
              reporter = require(path3.resolve(reporterName));
            } catch (err2) {
...
async function run() {
  ...
  const testsRoot = path2.resolve(__dirname);
  const files = await glob("**/**.test.ts", { cwd: testsRoot });
  files.forEach((f) => mocha.addFile(path2.resolve(testsRoot, f)));
